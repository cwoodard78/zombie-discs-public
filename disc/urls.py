...
from .views import DiscListCreateAPIView, DiscDetailAPIView, RecentDiscsAPIView
...
urlpatterns = [
    ...
    # path('discs/', DiscListCreateAPIView.as_view(), name='disc-list-create'),
    # path('discs/<int:pk>/', DiscDetailAPIView.as_view(), name='disc-detail'),
    # path('api/discs/recent/', RecentDiscsAPIView.as_view(), name='recent_discs_api'),
